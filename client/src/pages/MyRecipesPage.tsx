            ...
            <Container style={{minHeight: "93vh"}} fluid>
                <Row style={{paddingBottom: "50px"}}>
                    {
                        hits.map((recipe:any) => {
                            ...
                            return (
                                <Col onClick={() => openUpdateModal(recipe)} key={id} style={{marginRight: 0, marginLeft: 0, padding:25}} xs={12} md={4}>
                                    <Card>
                ...
                <Modal isOpen={modalOpen} toggle={toggleModal}>
                    ...
                    <ModalFooter className="justify-content-between">
                        ...
                        <Button onClick={handleCreateClick} color="success">Create</Button>
                    </ModalFooter>
                </Modal>
